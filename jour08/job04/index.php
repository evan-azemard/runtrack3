        ...
        <form action="#">
            ...
            <p>
                <label>
                    ...
                    <span>Madame</span>
                    <i class="material-icons right">pregnant_woman</i>
                </label>
            </p>
        </form>
              ...
              <form class="col s12">
                <div class="row">
                    ...
                    <div class="input-field col s6">
                        ...
                        <i class="material-icons right">turned_in</i>
                    </div>
                </div>
                <div class="row">
        ...
        <!-- choix loisirs -->
         <form action="#">
            ...
            <p>
              ...
              <button class="btn waves-effect teal lighten-3" type="submit" name="action">Envoyer
